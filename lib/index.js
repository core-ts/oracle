...
export function buildToSave(obj, table, attrs, buildParam, ver, pks, i) {
  if (i == null) {
    i = 1;
  }
  if (!buildParam) {
...
export function executeBatch(con, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function* () {
...
export function executeBatchTx(con, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function* () {
    if (!statements || statements.length === 0) {
      return 0;
    }
...
export function save(con, obj, table, attrs, buildParam) {
...
export function saveBatch(con, objs, table, attrs, buildParam) {
...
export class OracleBufferedBatchWriterWriter {
  constructor(connection, table, attributes, size = 5000, map, buildParam) {
    this.connection = connection;
    this.table = table;
    this.attributes = attributes;
    this.size = size;
  ...
  flush() {
    if (!this.list || this.list.length === 0) {
      ...
      if (stmt) {
        return executeBatch(this.connection, stmt).then((r) => {
          this.list = [];
          return total;
        });
      }
